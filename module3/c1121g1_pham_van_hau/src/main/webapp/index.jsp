    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h2><b>Thư Viện Sách</b></h2>
                    </div>
                    <div class="col-sm-6">
                        <a href="/sach?action=the-muon-sach" class="btn btn-success"><i
                                class="material-icons">&#xE147;</i> <span>Danh sách mượn sách</span></a>
                    </div>
                </div>
                <div class="row">
                    <form method="get">
                        ...
                        <input class="mt-1" type="text" name="searchName" size="25" placeholder="Nhập tên sách"
                               value="${searchName}">
            ...
            <table id="example" class="table table-striped table-hover">
                ...
                <c:forEach var="sach" items="${list}">
                    <tr>
                        <td>${sach.getBookCode()}</td>
                        <td>${sach.getBookName()}</td>
                        <td>${sach.getBookAuthor()}</td>
                        <td>${sach.getBookAmount()}</td>
                        <td>${sach.getBookDescription()}</td>
                        <td>
                            <c:if test="${sach.getBookAmount()>0}">
                                <a href="/sach?action=muon-sach&bookId=${sach.getBookId()}"
                                   class="btn btn-primary text-white">Mượn</a>
                            </c:if>
                            <c:if test="${sach.getBookAmount()==0}">
                                <a href="#modalAlert" data-toggle="modal"
                                   class="btn btn-primary text-white">Mượn</a>
                            </c:if>
                        </td>
                    </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="font-size: 20px" class="text-center text-dark">
                        Hiện Sách này đã hết !
                    </p>
                </div>
                <div class="modal-footer">
                    <input type="button" class="btn btn-dark" data-dismiss="modal" value="OK">
                </div>
